...
anneal_cmd="mpirun lmp -var id 1 -in ../Inputs/production_3d_binary.lmp"
...
for temp in "${temperatures[@]}"; do
    mpirun lmp -var configfile ../Inputs/n360/kalj_n360_T${temp}.lmp -var id 1 -in ../Inputs/production_3d_binary.lmp
        ...
        #$anneal_cmd -var configfile ../Inputs/n360/kalj_n360_create.lmp -in "$anneal_file"
done
