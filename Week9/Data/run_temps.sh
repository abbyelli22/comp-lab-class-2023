...
for temp in "${temps_list[@]}"; do
    mpirun lmp -var configfile ../Inputs/n360/kalj_n360_T$temp.lmp -var id 1 -in ../Inputs/anneal_3d_binary.lmp -log log_kalj_n360_T$temp.log
done
